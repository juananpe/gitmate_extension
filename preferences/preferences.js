	...
	init: async function () {
		...
		Zotero.Prefs.loadNamespace('shortcuts').then(function () {
			...
			for (let span of spans) {
				ReactDOM.render(React.createElement(Zotero_Preferences.Components.ShortcutInput, { pref: span.dataset.pref }), span);
			}
		});
...
Zotero_Preferences.Components.ShortcutInput = class extends React.Component {
	...
	render() {
		...
		return React.createElement("input", { className: classes, onKeyDown: this.handleKeyDown, onBlur: this.handleBlur, value: val });
	}
};
